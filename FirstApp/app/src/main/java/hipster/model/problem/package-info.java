...
/**
 * <p>
 * Util classes to create a new search problem. Use {@link hipster.model.problem.ProblemBuilder}
 * to define a search problem required to instantiate a new algorithm with {@link hipster.algorithm.Hipster}
 * class. Example:
 * </p>
